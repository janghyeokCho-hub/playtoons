  ...
  const processRsultData = (result) => {
    const tempData = [
      ...
      },
      {
        ...
        category : "アクション",
        date : "2022/06/11",
        status : <React.Fragment>休載中<br />(2022/06/10~)</React.Fragment>
      }
    ];
    ...
    return tempData.map( (value, index) => {
      return <Tr key={index}>
        ...
        <Td width={size.image} ><Image src={value.image} /></Td>
    ...
    <SeriesContainer>
      <TitleContainer>
        ...
        <SeriesAddButtonContainer>
          <ButtonOutline width={180} text={"シリーズを追加"} icon={iconPathPlus} />
        </SeriesAddButtonContainer>
      </TitleContainer>
      <Table>
        <Header>
